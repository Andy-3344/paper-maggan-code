...
postive_sample1 = pd.read_csv('D:/论文/magcn-seqgan/dataset/lncrnadisease/feature/data_label_feature.csv', header=None, names=list, encoding="utf-8")
negative_sample = pd.read_csv("D:/论文/magcn-seqgan/dataset/lncrnadisease/feature/data_unlabel_feature.csv", header=None, names=list, encoding="utf-8")
...
shuffled_all_sample.to_csv('shuffled_all_sample.csv', header=None, index=None)