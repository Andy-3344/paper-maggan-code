...
df = pd.read_csv('D:/论文/magcn-seqgan/dataset/lncrnadisease/feature/data_unlabel_feature.csv', header=None)
print(df)
SEQ_LENGTH = df.shape[1]


def read_sampleFile(file='D:/论文/magcn-seqgan/dataset/lncrnadisease/feature/data_unlabel_feature.csv', pad_token='PAD', num=None):
...
x, vocabulary, reverse_vocab, x_lengths = read_sampleFile(num=4736)
x = x.tolist()
output_file = 'unlabel.data'
...
torch.save(reverse_vocab, 'reverse_vocab_unlabel.pkl')
